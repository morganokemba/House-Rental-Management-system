					...
					<table id="example" class="display responsive_display" style="width:100%">
						...
						?>
							<tr>
								...
								<td>
									<a href="property_booking.php?renterid=<?php echo $notification['renterId'];?>&&ownerid=<?php echo $notification['ownerId'];?>&&adid=<?php echo $notification['adId'];?>&&nftid=<?php echo $notification['notfId'];?>">Approve now</a> 
